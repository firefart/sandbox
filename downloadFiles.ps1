...
Try {
  ...
  Download-File -url "https://github.com/0xd4d/dnSpy/releases/download/v6.1.7/dnSpy-net472.zip" -path "$($PSScriptRoot)\scripts\setups\dnSpy.zip"
  Download-File -url "https://www.python.org/ftp/python/3.8.5/python-3.8.5-amd64.exe" -path "$($PSScriptRoot)\scripts\setups\python3.exe"
  ...
  Download-File -url "https://nmap.org/npcap/dist/npcap-0.9997.exe" -path "$($PSScriptRoot)\scripts\setups\npcap.exe"
  Download-File -url "https://1.eu.dl.wireshark.org/win64/Wireshark-win64-3.2.6.exe" -path "$($PSScriptRoot)\scripts\setups\wireshark.exe"
  # dep for pebear
  ...
  Download-File -url "https://github.com/hasherezade/pe-bear-releases/releases/download/0.5.0/PE-bear_0.5.0_x64_win.zip" -path "$($PSScriptRoot)\scripts\setups\pebear.zip"
