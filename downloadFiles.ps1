...
Try {
  ...
  Download-File -url "https://github.com/notepad-plus-plus/notepad-plus-plus/releases/download/v7.9.5/npp.7.9.5.Installer.x64.exe" -path "$($PSScriptRoot)\scripts\setups\notepad++.exe"
  ...
  Download-File -url "https://ghidra-sre.org/ghidra_9.2.2_PUBLIC_20201229.zip" -path "$($PSScriptRoot)\scripts\setups\ghidra.zip"
  ...
  Download-File -url "https://www.python.org/ftp/python/3.9.2/python-3.9.2-amd64.exe" -path "$($PSScriptRoot)\scripts\setups\python3.exe"
  ...
  Download-File -url "https://nmap.org/npcap/dist/npcap-1.20.exe" -path "$($PSScriptRoot)\scripts\setups\npcap.exe"
  Download-File -url "https://1.eu.dl.wireshark.org/win64/Wireshark-win64-3.4.4.exe" -path "$($PSScriptRoot)\scripts\setups\wireshark.exe"
  ...
  Download-File -url "https://github.com/hasherezade/pe-bear-releases/releases/download/0.5.3.2/PE-bear_0.5.3.2_x86_win_vs17.zip" -path "$($PSScriptRoot)\scripts\setups\pebear.zip"
