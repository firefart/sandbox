...
Try {
  ...
  Download-File -url "https://github.com/0xd4d/dnSpy/releases/download/v6.1.6/dnSpy-net472.zip" -path "$($PSScriptRoot)\scripts\setups\dnSpy.zip"
  Download-File -url "https://www.python.org/ftp/python/3.8.4/python-3.8.4-amd64.exe" -path "$($PSScriptRoot)\scripts\setups\python3.exe"
  ...
  Download-File -url "https://nmap.org/npcap/dist/npcap-0.9995.exe" -path "$($PSScriptRoot)\scripts\setups\npcap.exe"
